...
public class GeekTweenPosition : GeekTweener
{
	public Vector3 from;
	public Vector3 to;
	...
	static public GeekTweenPosition Begin (GameObject go, float duration, Vector3 pos)
	{
		GeekTweenPosition comp = GeekTweener.Begin<GeekTweenPosition>(go, duration);
