...
public abstract class GeekTweener : IgnoreTimeScale
{
	...
	public delegate void OnFinished (GeekTweener tween);
	...
	static public T Begin<T> (GameObject go, float duration) where T : GeekTweener
	{
