...
public abstract class EZTweener : MonoBehaviour
{
	public enum Method
	{
		Linear,
	...
	public delegate void OnFinished (EZTweener tween);
	...
	protected void OnEnable () {  /*mStartTime = Time.realtimeSinceStartup + delay; */}
	...
	public void doStart () { /*mStartTime = Time.realtimeSinceStartup + delay; Update(); */}
	public void Update(){
	...
	static public T Begin<T> (GameObject go, float duration) where T : EZTweener
	{
