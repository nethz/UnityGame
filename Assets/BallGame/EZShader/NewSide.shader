    ...
    SubShader {
        ...
        Pass {
			...
			fixed4 frag ( v2f _in ) : COLOR {
				...
				fixed4 out3 = tex2D ( _MainTex, _in.texcoord +float2(0, -_side) );
				fixed4 out4 = tex2D ( _MainTex, _in.texcoord +float2(-_side, 0) ); 
				
				//out1.r = out1.a;// + out2.a + out3.a + out4.a;
				//outColor += (out1.r!=0 && outColor.a ==0)? _in.color: fixed4(0,0,0,0);
            	outColor = _in.color*(1-outColor.a) + outColor*outColor.a;
            	outColor.a = out1.a+out2.a +out3.a+out4.a;
