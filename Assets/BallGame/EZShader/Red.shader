...
Shader "EZ/Effect/red" {
    Properties {
        _MainTex ("Atlas Texture", 2D) = "white" {}
        _interpreter ("interpreter", float) = 0 
    ...
    SubShader {
        ...
        Pass {
			...
			fixed4 frag ( v2f _in ) : COLOR {
				...
				//_in.color.a = outColor.a * _interpreter * _in.color.a;
				_in.color *=outColor.a *_interpreter * _in.color.a;
				//_in.color.g *=outColor.a *_interpreter;
				//_in.color.b *=outColor.a*_interpreter;
                return _in.color;
			}
			ENDCG
        }
