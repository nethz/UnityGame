...
class EZRivalCrystal extends MonoBehaviour{
	public var _method:GeekTweener.Method = GeekTweener.Method.Linear;
	static private var instance_:EZRivalCrystal = null;
	...
	public static function GetInstance():EZRivalCrystal{
		return instance_;
	}
