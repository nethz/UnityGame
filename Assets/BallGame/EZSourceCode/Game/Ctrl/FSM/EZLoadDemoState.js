...
class EZLoadDemoState extends StateWithEventMap{
	...
	public function EZLoadDemoState(loader:EZLoader,  dialog:EZGameDialogView,  map:EZGameMapView, context:EZModelContext){
		loader_ = loader;
		dialog_ = dialog;
		map_ = map;
		context_ = context;
