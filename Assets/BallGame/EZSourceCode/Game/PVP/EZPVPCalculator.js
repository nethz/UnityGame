#pragma strict
class EZPVPCalculator extends MonoBehaviour
{	
	...
	public function magicResult(fighter:EZFighter):EZTechniqueData{
		if(fighter.alive()){
			...
			Debug.Log(fighter.target.getSeat());
	...
	public function crystalResult(fighter:EZFighter):EZTechniqueData{
		if(fighter.alive() && fighter.getCrystal){
			Debug.LogWarning(fighter);
			Debug.LogWarning(fighter.target);
			Debug.LogWarning(fighter.target.getSeat());
