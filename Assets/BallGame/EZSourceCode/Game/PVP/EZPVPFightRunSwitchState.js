...
class EZPVPFightRunSwitchState extends StateWithEventMap{
	private var isOver_:boolean = false;
	
	private var context_:EZModelContext = null;
	
	public function EZPVPFightRunSwitchState(context:EZModelContext){
		context_ = context;  
	} 
	...
	function start(){
		...
		Debug.Log("EZPVPFightRunSwitchState");
		isOver_ = false;
