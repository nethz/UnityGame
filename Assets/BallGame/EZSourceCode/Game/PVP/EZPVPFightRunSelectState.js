#pragma strict
class EZPVPFightRunSelectState extends State{
	private var isOver_:boolean;
	private var context_:EZModelContext = null;
	
	public function start(){
		Debug.Log("EZPVPFightRunSelectState");
		isOver_ = false;
	...
	public function EZFightRunSelectState(context:EZModelContext){
		context_ = context;  
	} 
