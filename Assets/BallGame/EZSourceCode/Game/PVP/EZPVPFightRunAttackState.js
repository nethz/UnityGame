#pragma strict
class EZPVPFightRunAttackState extends StateWithEventMap{
	private var isOver_:boolean;
	private var context_:EZModelContext;
	function EZPVPFightRunAttackState(context:EZModelContext){
	...
	private function doCrystal(tl:TaskList, technique:EZTechniqueData){
		...
		tl.push(aTask);
		EZTechniqueHandler.DoTechnique(tl, technique, EZTechniqueHandler.RivalDie()); 
